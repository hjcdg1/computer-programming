...
class IronmanRepulsor extends Ironman implements Repulsor
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[Repulsor]";
    }
}
...
class IronmanFireBlaster extends Ironman implements FireBlaster
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[FireBlaster]";
    }
}
...
class IronmanWhipFlash extends Ironman implements WhipFlash
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[WhipFlash]";
    }
}
...
class IronmanRepulsorFireBlaster extends Ironman implements Repulsor, FireBlaster
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[Repulsor][FireBlaster]";
    }
}
...
class IronmanRepulsorWhipFlash extends Ironman implements Repulsor, WhipFlash
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[Repulsor][WhipFlash]";
    }
}
...
class IronmanHulkBuster extends Ironman implements HulkBuster
{
    ...
    public String print()
    {
        return name + "[" + Integer.toString(health) + "]" + "_ArmorType[HulkBuster]";
    }
}
